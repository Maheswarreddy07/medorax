...
def get_settings(
    ...
    active_pharmacy_id = get_current_pharmacy_id(db, current_user.id, pharmacy_id, Permissions.SETTINGS_MANAGE.code)
    return SettingService.get_or_create_settings(db, active_pharmacy_id)
