        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Manage your healthcare team members, roles, and access permissions.
            </p>
            <div className="mt-3 flex items-center gap-4 text-xs text-slate-400">
              <span className="inline-flex items-center gap-1.5">
                <UserCheck size={13} className="text-blue-500" />
                <span className="font-semibold text-slate-600">48</span> Staff Members
              </span>
              <span className="h-3 w-px bg-slate-200" />
              <span>
                <span className="font-semibold text-emerald-600">32</span> Active
              </span>
              <span className="h-3 w-px bg-slate-200" />
              <span>
                <span className="font-semibold text-amber-600">4</span> On Leave
              </span>
            </div>
          </div>
        </div>
