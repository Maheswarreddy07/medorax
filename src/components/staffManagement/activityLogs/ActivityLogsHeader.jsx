  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-600 via-blue-500 to-cyan-500 p-6 shadow-lg sm:p-8">
      ...
      <div className="relative flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <button
          type="button"
          className="inline-flex items-center gap-2 rounded-xl bg-white px-5 py-2.5 text-sm font-semibold text-indigo-700 shadow-md transition-all duration-200 hover:shadow-lg hover:brightness-95 active:scale-[0.98]"
        >
          <Download size={18} />
          Export CSV
        </button>
