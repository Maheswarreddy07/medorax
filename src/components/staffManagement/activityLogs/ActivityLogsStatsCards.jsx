...
const ActivityLogsStatsCards = () => {
  return (
    <div className="grid grid-cols-1 gap-6">
      {/* Weekly Trend */}
      <div className="group relative col-span-1 overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
        ...
        <div className="relative flex items-center gap-6">
          <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 to-cyan-500 text-white shadow-lg shadow-indigo-200">
            <TrendingUp size={32} strokeWidth={2.2} />
          </div>
          <div>
            <h4 className="text-xl font-bold text-slate-900">Weekly Trend</h4>
            <p className="mt-1 text-base text-slate-500">
              There is a{" "}
              <span className="font-semibold text-emerald-600">12% increase</span>{" "}
