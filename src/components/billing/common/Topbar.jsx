  ...
  return (
    <header className="sticky top-0 z-40 flex h-20 items-center justify-between border-b border-slate-200 bg-white px-8 shadow-sm">
      ...
      <div className="ml-8 flex items-center gap-5">
        <button
          type="button"
          className="rounded-xl bg-linear-to-br from-[#2563EB] via-[#14B8A6] to-[#10B981] px-5 py-2.5 text-sm font-semibold text-white shadow-md transition-transform duration-200 hover:scale-[1.02] active:scale-95"
        >
