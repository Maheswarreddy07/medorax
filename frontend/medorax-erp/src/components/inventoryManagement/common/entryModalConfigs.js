...
export const damagedStockFields = [
  { name: "sku", label: "SKU / Item Code", type: "text", placeholder: "e.g. MED-AMX-050", required: true },
  { name: "medicineName", label: "Item Name", type: "text", placeholder: "Search or enter item name...", required: true, fullWidth: true },
  { name: "quantity", label: "Damaged Quantity", type: "number", min: "0", placeholder: "0", required: true },
  { name: "unit", label: "Unit", type: "select", options: ["Tablets", "Strips", "Bottles", "Vials", "Boxes"], required: true },
  { name: "warehouse", label: "Warehouse / Location", type: "select", options: warehouses, required: true, fullWidth: true },
  { name: "reason", label: "Reason for Damage", type: "text", placeholder: "e.g. Mishandling, Expired, Water Damage", required: true, fullWidth: true },
];

export const expiredStockFields = [
  { name: "sku", label: "SKU / Item Code", type: "text", placeholder: "e.g. MED-AMX-050", required: true },
  { name: "medicineName", label: "Item Name", type: "text", placeholder: "Search or enter item name...", required: true, fullWidth: true },
  { name: "quantity", label: "Expired Quantity", type: "number", min: "0", placeholder: "0", required: true },
  { name: "unit", label: "Unit", type: "select", options: ["Tablets", "Strips", "Bottles", "Vials", "Boxes"], required: true },
  { name: "warehouse", label: "Warehouse / Location", type: "select", options: warehouses, required: true, fullWidth: true },
];

export const stockTransferFields = [
  { name: "sku", label: "SKU / Item Code", type: "text", placeholder: "e.g. MED-AMX-050", required: true },
  { name: "medicineName", label: "Item Name", type: "text", placeholder: "Search or enter item name...", required: true, fullWidth: true },
  { name: "quantity", label: "Transfer Quantity", type: "number", min: "1", placeholder: "0", required: true },
  { name: "fromWarehouse", label: "From Warehouse", type: "select", options: warehouses, required: true },
  { name: "toWarehouse", label: "To Warehouse", type: "select", options: warehouses, required: true },
];

export const reorderStockFields = [
  { name: "sku", label: "SKU / Item Code", type: "text", placeholder: "e.g. MED-AMX-050", required: true },
  { name: "medicineName", label: "Item Name", type: "text", placeholder: "Search or enter item name...", required: true, fullWidth: true },
  { name: "quantity", label: "Reorder Quantity", type: "number", min: "1", placeholder: "100", required: true },
  { name: "warehouse", label: "Warehouse / Location", type: "select", options: warehouses, required: true, fullWidth: true },
];

export const redistributeStockFields = [
  { name: "sku", label: "SKU / Item Code", type: "text", placeholder: "e.g. MED-AMX-050", required: true },
  { name: "medicineName", label: "Item Name", type: "text", placeholder: "Search or enter item name...", required: true, fullWidth: true },
  { name: "quantity", label: "Redistribute Quantity", type: "number", min: "1", placeholder: "500", required: true },
  { name: "fromWarehouse", label: "From Warehouse (Surplus)", type: "select", options: warehouses, required: true },
  { name: "toWarehouse", label: "To Warehouse (Target)", type: "select", options: warehouses, required: true },
];

export const nearExpiryClearanceFields = [
  { name: "sku", label: "SKU / Item Code", type: "text", placeholder: "e.g. MED-AMX-050", required: true },
  { name: "medicineName", label: "Item Name", type: "text", placeholder: "Search or enter item name...", required: true, fullWidth: true },
  { name: "quantity", label: "Clearance / Discount Qty", type: "number", min: "1", placeholder: "50", required: true },
  { name: "actionType", label: "Action Type", type: "select", options: ["Discount Sale", "Return to Supplier", "Priority Transfer"], required: true },
];
